...
const DATA_SOURCE_NAME = 'Resource';

export class ResourceService {
  static async create(record: Omit<Resource, 'id'>): Promise<Resource> {
  ...
  static async getAll(options?: IOperationOptions): Promise<Resource[]> {
